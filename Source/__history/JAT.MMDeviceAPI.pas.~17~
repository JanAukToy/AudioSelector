...
const
  ...
  PKEY_DeviceInterface_FriendlyName: TPropertyKey = (fmtid: (D1: $026E516E;
    D2: $B814; D3: $414B; D4: ($83, $CD, $85, $6D, $6F, $EF, $48, $22)
    ); pid: 2);

  PKEY_Device_DeviceDesc: TPropertyKey = (fmtid: (D1: $A45C254E; D2: $DF1C;
    D3: $4EFD; D4: ($80, $20, $67, $D1, $46, $A8, $50, $E0)); pid: 2);

  PKEY_Device_InstanceId: TPropertyKey = (fmtid: (D1: $78C34FC8; D2: $104A;
    D3: $4ACA; D4: ($9E, $A4, $52, $4D, $52, $99, $6E, $57)); pid: 256);

  PKEY_Device_FriendlyName: TPropertyKey = (fmtid: (D1: $A45C254E; D2: $DF1C;
    D3: $4EFD; D4: ($80, $20, $67, $D1, $46, $A8, $50, $E0)); pid: 14);

  PKEY_Device_ContainerId: TPropertyKey = (fmtid: (D1: $8C7ED206; D2: $3F8A;
